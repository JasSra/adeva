...
namespace DebtManager.Infrastructure.Migrations
{
    ...
    [Migration("20251011051921_AddOrgApplicationAndBankFields")]
    partial class AddOrgApplicationAndBankFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DebtManager.Domain.Audit.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DebtManager.Domain.Communications.InternalMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DebtManager.Domain.Communications.InternalMessageRecipient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("InternalMessageRecipients");
                });

            modelBuilder.Entity("DebtManager.Domain.Communications.MessageTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DebtManager.Domain.Communications.QueuedMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DebtManager.Domain.Organizations.Organization", b =>
                {
                    ...
                    b.Property<string>("ApplicationApprovalNote")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("PhoneVerificationNotes")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DebtManager.Domain.Organizations.OrganizationFeeConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<bool>("AutomaticPayoutsEnabled")
                        .HasColumnType("bit");

                    b.Property<DateTime>("CreatedAtUtc")
                        .HasColumnType("datetime2");

                    b.Property<decimal>("CustomPlanAdminFeeFlat")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("CustomPlanAdminFeePercentage")
                        .HasPrecision(9, 4)
                        .HasColumnType("decimal(9,4)");

                    b.Property<int>("DefaultInstallmentPeriodWeeks")
                        .HasColumnType("int");

                    b.Property<decimal>("FullPaymentDiscountPercentage")
                        .HasPrecision(9, 4)
                        .HasColumnType("decimal(9,4)");
                    ...
                    b.Property<int>("MaximumInstallmentCount")
                        .HasColumnType("int");

                    b.Property<decimal>("MinimumInstallmentAmount")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("PaymentProcessingFeePercentage")
                        .HasPrecision(9, 4)
                        .HasColumnType("decimal(9,4)");

                    b.Property<int>("RemittanceFrequency")
                        .HasColumnType("int");

                    b.Property<decimal>("SystemPlanDiscountPercentage")
                        .HasPrecision(9, 4)
                        .HasColumnType("decimal(9,4)");
                    ...
                    b.ToTable("OrganizationFeeConfigurations");
                });
            ...
            modelBuilder.Entity("DebtManager.Domain.Communications.InternalMessageRecipient", b =>
                {
                    b.HasOne("DebtManager.Domain.Communications.InternalMessage", "InternalMessage")
                        .WithMany("Recipients")
            ...
            modelBuilder.Entity("DebtManager.Domain.Organizations.OrganizationFeeConfiguration", b =>
                {
                    b.HasOne("DebtManager.Domain.Organizations.Organization", null)
                        .WithMany()
                        .HasForeignKey("OrganizationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
